  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-primary p-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-background px-8 py-10 rounded-2xl shadow-lg border border-border" autoComplete="off">
          <div className="flex flex-col gap-0 my-4">
            <h1 className="text-2xl font-bold text-left mb-2 text-foreground">Sign Up</h1>
            <p className="text-sm text-foreground/80 mb-6">Create your account</p>
          </div>

          <div className="mb-4">
            <label className="block mb-1 text-foreground font-medium">First Name</label>
            <Input
              type="text"
              name="firstName"
              required
          ...
          <div className="mb-4">
            <label className="block mb-1 text-foreground font-medium">Last Name</label>
            <Input
              type="text"
              name="lastName"
              required
          ...
          <div className="mb-4">
            <label className="block mb-1 text-foreground font-medium">Password</label>
            <div className="relative">
              <Input
          ...
          <div className="mb-4">
            <label className="block mb-1 text-foreground font-medium">Phone</label>
            <Input
              type="tel"
              name="phone"
              required
          ...
          <div className="mb-10">
            <label className="block mb-1 text-foreground font-medium">Role</label>
            <Select
              disabled={isPending}
              value={formData.role}
