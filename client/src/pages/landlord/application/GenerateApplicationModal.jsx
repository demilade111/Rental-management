...
const GenerateApplicationDialog = ({ isOpen, onClose, listings, onGenerated }) => {
    ...
    const handleGenerate = () => {
        ...
        generateApplicationMutation.mutate({ listingId: selectedListing, requirements });
    };
    ...
    return (
        <>
            ...
            <Dialog open={isOpen} onOpenChange={(open) => {
                ...
                >
                    <DialogHeader>
                        <DialogTitle className="text-xl text-center mt-2">Create Application Link</DialogTitle>
                    </DialogHeader>
                    ...
                    <div className="space-y-6 mt-2 w-full">
                        ...
                        <div className="mt-4">
                            <label className="text-sm text-gray-600 mb-1 block">Expiration Date</label>
                    ...
                    <DialogFooter className="flex justify-end gap-2 mt-4">
                        ...
                        >
                            {generateApplicationMutation.isPending ? "Generating..." : "Generate Link"}
                        </Button>
                        <Button className="rounded-xl" variant="secondary" onClick={onClose}>
                            Close
                        </Button>
                    </DialogFooter>
                </DialogContent>
            ...
            {/* Link Dialog */}
            <Dialog open={linkDialogOpen} onOpenChange={() => setLinkDialogOpen(false)}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <DialogFooter className="flex justify-end mt-4">
                        <Button className="rounded-xl" variant="secondary" onClick={() => setLinkDialogOpen(false)}>
                            Close
                        </Button>
                    </DialogFooter>
                </DialogContent>
