...
const FilterStandardLeaseDialog = ({ open, onClose, filters, onApply }) => {
    const [status, setStatus] = useState("");
    const [startDate, setStartDate] = useState(null);
    const [endDate, setEndDate] = useState(null);

    // Initialize filters when dialog opens or when filters change
    useEffect(() => {
        if (open && filters) {
...
export default FilterStandardLeaseDialog;
